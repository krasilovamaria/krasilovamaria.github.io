...
<php lang="ru">
  <head>
    <title>Личный кабинет - YogaApp</title>
    <meta charset="utf-8"/>
      ...
      <main>
        <section class="account">
          <div class="account__container">
            ...
            <form class="form account__form" method="get" action="#">
              <div class="input">
                <label>Имя</label>
                <input name="name" id="name" type="name" placeholder="Имя" autocomplete="off" required="required" value="Александр"/><span class="visually-hidden" id="error-message-name">Ошибка! Введите цифры и латинские буквы, от 4 до 20 символов</span>
              </div>
              <div class="input">
                <label>Фамилия</label>
                <input name="lastname" id="lastname" type="lastname" placeholder="Фамилия" autocomplete="off" required="required" value="Дрон"/><span class="visually-hidden" id="error-message-lastname">Ошибка! Введите цифры и латинские буквы, от 4 до 20 символов</span>
              </div>
              <div class="input">
                <label>Дата рождения</label>
                <input name="birthdate" id="birthdate" type="birthdate" placeholder="Дата рождения" autocomplete="off" required="required" value="00.00.00"/><span class="visually-hidden" id="error-message-birthdate">Ошибка! Введите цифры и латинские буквы, от 4 до 20 символов</span>
              </div>
              <div class="input">
                <label class="visually-hidden" for="email"></label>
                <input name="email" id="email" type="email" placeholder="aleksandr.dron91@yandex.by" autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-email">Ошибка! Введите цифры и латинские буквы, от 4 до 20 символов</span>
              </div>
              <div class="input">
                <label class="visually-hidden" for="tel"></label>
                <input name="tel" id="tel" type="tel" placeholder="+7 (999) 440 - 35 - 38 " autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-tel">Ошибка! Введите цифры</span>
              </div>
              <div class="input">
                <label>Страна</label>
                <input name="country" id="country" type="country" placeholder="Страна" autocomplete="off" required="required" value="Россия"/><span class="visually-hidden" id="error-message-country">Ошибка! Введите цифры и латинские буквы, от 4 до 20 символов</span>
              </div>
              <div class="input">
                <label>Город</label>
                <input name="city" id="city" type="city" placeholder="Город" autocomplete="off" required="required" value="Красноярск"/><span class="visually-hidden" id="error-message-city">Ошибка! Введите цифры и латинские буквы, от 4 до 20 символов</span>
              </div><a class="button button--border-circle account__button" href="create-workout.php">Сохранить</a>
              <p class="account__conf">Нажимая кнопку «Сохранить», вы&nbsp;даёте своё согласие на&nbsp;обработку персональных данных в&nbsp;соответствии с&nbsp;<a href="confidentiality.php" target="_blank">Политикой конфиденциальности</a></p>
            </form><a class="button button--border-circle account__button" href="main.php">Выйти из аккаунта</a>
          </div>
          <div class="account__container">
            <h2>Подписаться на YogaApp 1299₽ раз в месяц</h2>
            <form class="form account__form" method="get" action="#">
              <div class="input">
                <label class="visually-hidden" for="card"></label>
                <input name="card" id="card" type="text" placeholder="0000 0000 0000 0000" autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-card">Ошибка! Введите номер карты</span>
              </div>
              <div class="input">
                <label class="visually-hidden" for="cardDate"></label>
                <input name="cardDate" id="cardDate" type="text" placeholder="ММ/ГГ" autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-cardDate">Ошибка! Введите дату</span>
              </div>
              <div class="input">
                <label class="visually-hidden" for="cardCode"></label>
                <input name="cardCode" id="cardCode" type="text" placeholder="Код CVV/CVC" autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-cardCode">Ошибка! Введите код</span>
              </div>
              <div class="input">
                <label class="visually-hidden" for="cardName"></label>
                <input name="cardName" id="cardName" type="text" placeholder="Имя и фамилия" autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-cardName">Ошибка! Введите код</span>
              </div>
              <button class="button button--yellow account__button" type="button">Подписаться</button>
              <p class="account__conf">Нажимая кнопку «Подписаться», вы тем самым разрешаете ежемесячно списывать с вашей карты сумму в 1299р. Вы всегда можете отметить подписку.</p>
            </form>
          </div>
          <div class="account__container account__container--cancel">
            <h2>Подписка на YogaApp 1299₽ раз в месяц</h2>
            <button class="button button--yellow account__button" type="button">Отменить подписку</button>
          </div>
        </section>
      </main>
      <footer class="footer">
