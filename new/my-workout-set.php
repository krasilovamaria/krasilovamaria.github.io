...
<php lang="ru">
  <head>
    <title>Мои тренировки - YogaApp</title>
    <meta charset="utf-8"/>
...
<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"/>
  ...
  <ellipse cx="218.279" cy="104.5" rx="11.2981" ry="12.5" fill="black"/>
      ...
      <main>
        <h1 class="visually-hidden">Мои тренировки</h1>
        <section class="exercises-container">
          <sidebar class="sidebar">
            <ul class="sidebar__list">
              ...
              <li class="sidebar__item"><a class="sidebar__link sidebar__link--active">Мои тренировки</a>
              </li>
          ...
          <div class="workout">
            <div class="container">
              <div class="workout__wrapper">
                <div class="card-video-my-workout">
                  <p>Спина</p>
                  <p>Дата создания 01.12.2021</p>
                  ...
                  <button class="button button--border-circle" type="button">Редактировать название</button>
                  <button class="button button--border-circle" type="button">Удалить тренировку</button>
                </div>
                <div class="card-video-my-workout">
                  <p>Ягодицы</p>
                  <p>Дата создания 05.12.2021</p>
                  <video src="video/w_1.mp4" width="400" height="200" type="video/mp4" poster="img/content/poster/w_1.jpg" playsinline="playsinline" controls="controls" preload="preload"></video>
                  <button class="button button--border-circle" type="button">Редактировать название</button>
                  <button class="button button--border-circle" type="button">Удалить тренировку</button>
                </div>
