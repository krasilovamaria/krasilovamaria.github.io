...
<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"/>
  ...
  <circle cx="52.5" cy="25.5" r="2.5" fill="white"/>
    ...
    <div class="wrapper">
      ...
      <main>
        <div class="container"><a class="components-backwards" href="index.php"><span>&larr;</span><span>вернуться на разводящую</span></a>
          <h1>Компоненты, используемые в вёрстке</h1>
          <section>
            <h2>Модалки</h2>
            <p><a href="#" data-modal="feedback">modal--feedback link</a></p>
            <p><a href="#" data-modal="success">modal--success link</a></p>
          </section>
          <section>
            <h2>Название компонента или группы компонентов</h2>
            <p>Класс компонента \ модификаторы</p>
            <p style="color: red;">При необходимости, подсказки \ предупреждение \ важная информация</p>
            <div>Компонент</div>
          </section>
        </div>
      </main>
  ...
  <ellipse cx="218.279" cy="104.5" rx="11.2981" ry="12.5" fill="black"/>
    ...
    <div class="modal modal--preload modal--success modal--no-scale modal--fit-content">
      <div class="modal__wrapper">
        <div class="modal__overlay"></div>
        <div class="modal__content">
