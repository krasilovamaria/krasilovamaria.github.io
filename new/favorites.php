        ...
        <section class="exercises-container">
          <sidebar class="sidebar">
            <ul class="sidebar__list">
              ...
              <li class="sidebar__item"><a class="sidebar__link sidebar__link--active">Избранное</a>
              </li>
            </ul>
          </sidebar>
          <div class="workout">
            <div class="container">
              <div class="workout__wrapper">
                <div class="card-video">
                  ...
                  <button class="button button--border-circle" type="button">Удалить из избранного</button>
                </div>
                <div class="card-video">
                  <p>Комплекс 'Прокачай спину'</p>
                  <video src="video/w_1.mp4" width="400" height="200" type="video/mp4" poster="img/content/poster/w_1.jpg" playsinline="playsinline" controls="controls" preload="preload"></video>
                  <button class="button button--border-circle" type="button">Удалить из избранного</button>
                </div>
                <div class="card-video">
