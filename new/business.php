...
<php lang="ru">
  <head>
    <title>Возможности - YogaApp</title>
    <meta charset="utf-8"/>
...
<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"/>
  ...
  <ellipse cx="218.279" cy="104.5" rx="11.2981" ry="12.5" fill="black"/>
            ...
            <div class="main-nav__wrapper">
              <div class="main-nav__list-menu">
                ...
                <ul class="main-nav__list">
                  ...
                  <li class="main-nav__item"><a class="main-nav__link main-nav__link--active">Возможности</a>
                  </li>
      ...
      <main>
        <h1 class="visually-hidden">Возможонсти</h1>
        <section class="business">
          <h2>Как получить вознаграждение:</h2>
          <ul>
            <li>Обратить внимание в своем личном кабинете на Ваш код пользователя</li>
            <li>Передать данный код пользователя тому человеку, который пришел на этот сайт благодаря Вам</li>
            <li>Получать ежемесячно вознаграждение на Вашу карту в размере 35% от стоимости подписки тех людей которых вы пригласили на YogaApp или же скидку на подписку (на Ваш выбор)</li>
            <li>Под Вашим кодом может регестрироваться неограниченное количество людей, поэтому Ваш доход также неограничен</li>
          </ul>
        </section>
      </main>
      <footer class="footer">
