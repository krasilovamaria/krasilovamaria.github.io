...
<php lang="ru">
  <head>
    <title>Тренировки - YogaApp</title>
    <meta charset="utf-8"/>
...
<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"/>
  ...
  <ellipse cx="218.279" cy="104.5" rx="11.2981" ry="12.5" fill="black"/>
      ...
      <main>
        <h1 class="visually-hidden">Тренировки контент закрыт</h1>
        <section class="exercises-container">
          <div class="workout">
            <div class="container">
              <div class="workout__wrapper workout__wrapper--center">
                <p>Контент страницы будет доступен после Вашей подписки на сайт.<a class="button button--underline" href="registration.php">Добро пожаловать!</a></p>
              </div>
            </div>
          </div>
        </section>
