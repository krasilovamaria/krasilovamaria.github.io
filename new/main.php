...
<php lang="ru">
  <head>
    <title>Главная страница - YogaApp</title>
    <meta charset="utf-8"/>
...
<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg"/>
  ...
  <circle cx="52.5" cy="25.5" r="2.5" fill="white"/>
    ...
    <div class="wrapper">
      <header class="header">
        <div class="header__wrapper"><a class="header__logo"><svg width="282" height="140" viewBox="0 0 282 140" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <ellipse cx="218.279" cy="104.5" rx="11.2981" ry="12.5" fill="black"/>
      ...
      <main>
        <h1 class="visually-hidden">О сайте</h1>
        <section class="intro">
          <div class="container">
            <div class="intro__wrapper">
              <div class="intro__text">
                <h2>Приветствую!</h2>
                <p>Меня зовут Александр Дрон.</p>
                <p>
                  Я занимаюсь хатха-йогой, направлением по здоровой спине, цигуном уже более 10 лет.
                  Я создал программу тренировок, которая приведет Ваше тело в здоровое состояние и избавит от многих проблем.
                </p>
                <p>Вы сможете не только улучшить свою духовную и физическую форму, но и получите возможность дополнительного дохода &nbsp;<a class="intro__link" href="business.php">по программе "+1".</a></p>
                <p>
                  Я предлагаю Вам приобрести ежемесячную подписку на тренировки.
                  Вы сможете заниматься в подходящее для Вас время по индивидуальной программе созданной под Ваши интересы.
                  Данный комплекс тренировок - это исключительно уникальный продукт, в который я вложил свои знания для того, чтобы помочь Вам стать здоровее и счастливее.
                </p>
                <p>Добро пожаловать!</p><a class="button button--border-circle" href="workout.php">Начать тренироваться</a>
              </div>
              <div class="intro__img"><img src="img/content/intro.jpg" srcset="img/content/intro@2x.jpg 2x" width="200" height="400" alt="Александр Дрон"/>
              </div>
            </div>
          </div>
        </section>
        <section class="about">
          <div class="container">
            <h2 class="visually-hidden">О программе</h2>
            <div class="about__wrapper"><a class="card-about" href="workout.php">
                <p>Стоимость неограниченного количества индивидуальных тренировок в месяц всего 1299₽</p>
                <svg width="50" height="50" aria-hidden="true">
                  <use xlink:href="#icon-arrow-dark"></use>
                </svg></a><a class="card-about" href="workout.php">
                <p>Более 100 различных уникальных упражнений, которых нет на YouTube</p>
                <svg width="50" height="50" aria-hidden="true">
                  <use xlink:href="#icon-arrow-dark"></use>
                </svg></a><a class="card-about" href="business.php">
                <p>Программа Вашего ежемесячного дохода &quot;+1&quot;</p>
                <svg width="50" height="50" aria-hidden="true">
                  <use xlink:href="#icon-arrow-dark"></use>
                </svg></a>
            </div>
