...
/* harmony import */ var _modules_toggle_burger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/toggle-burger */ "./js/modules/toggle-burger.js");
/* harmony import */ var _modules_init_validate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-validate */ "./js/modules/init-validate.js");
...
/* harmony import */ var _modules_choose_level_workout__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/choose-level-workout */ "./js/modules/choose-level-workout.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_toggle_burger__WEBPACK_IMPORTED_MODULE_2__["initToggle"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_validate__WEBPACK_IMPORTED_MODULE_3__["initValidate"])();
    Object(_modules_phone_mask__WEBPACK_IMPORTED_MODULE_4__["initPhoneMask"])();
    Object(_modules_choose_level_workout__WEBPACK_IMPORTED_MODULE_5__["chooseLevelWorkout"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/choose-level-workout.js":
/*!********************************************!*\
  !*** ./js/modules/choose-level-workout.js ***!
  \********************************************/
/*! exports provided: chooseLevelWorkout */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "chooseLevelWorkout", function() { return chooseLevelWorkout; });
var chooseLevelWorkout = function chooseLevelWorkout() {
  var select = document.querySelector('[data-select="directed"]');
  var selectPrint = document.querySelector('[data-print="directed"]');

  if (selectPrint) {
    select.onchange = function () {
      selectPrint.innerHTML = this.value;
    };
  }

  var printChooseInput = function printChooseInput(inputsName, blockPrint) {
    var inputs = document.querySelectorAll(inputsName);
    var block = document.querySelector(blockPrint);
    inputs.forEach(function (item) {
      item.onchange = function () {
        block.innerHTML = item.value;
      };
    });
  };

  printChooseInput('[data-name="level"]', '[data-print="level"]');
  printChooseInput('[data-name="amountEx"]', '[data-print="amount-video"]');
};
...
var initValidate = function initValidate() {
  var regLogin = /^[a-zA-Z0-9_.]{4,20}$/;
  var regName = /^[а-яa-z]/i;
  var regInstagram = /^[a-zA-Z0-9_.]{1,20}$/;
  var regEmail = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
  var regPassword = /^[a-zA-Z0-9_.]{4,20}$/;
  ...
  if (inputs) {
    inputs.forEach(function (input) {
      input.addEventListener('input', function () {
        ...
        if (input.name === 'login') {
          if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regLogin, value)) {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(input);
          } else {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["valid"])(input);
          }
        } else if (input.name === 'username') {
          if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regName, value)) {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(input);
          } else {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["valid"])(input);
          }
        } else if (input.name === 'password') {
          if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regPassword, value)) {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(input);
          } else {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["valid"])(input);
          }
        } else if (input.name === 'instagram') {
          if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regInstagram, value)) {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(input);
          } else {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["valid"])(input);
          }
        } else if (input.name === 'email') {
          if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regEmail, value)) {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(input);
          } else {
            Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["valid"])(input);
          }
...
var initModal = function initModal(modalId, modal, btn) {
  switch (modalId) {
    case 'create-workout':
      Object(_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modal, false, btn, false, true, false);
      break;
...
var burgerCloseBtn = document.querySelector('.main-nav__close-button');
var navBlock = document.querySelector('.main-nav');
var navList = document.querySelector('.main-nav__list-menu');
...
/*!******************************!*\
  !*** ./js/utils/validate.js ***!
  \******************************/
/*! exports provided: getValidate, notValid, valid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var notValid = function notValid(input) {
  input.classList.add('on-error');
  var id = input.name;
  var idBlock = 'error-message-' + id;
