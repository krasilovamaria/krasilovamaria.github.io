...
/* harmony import */ var _modules_init_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-slider */ "./js/modules/init-slider.js");
/* harmony import */ var _modules_init_dropdown__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-dropdown */ "./js/modules/init-dropdown.js");
/* harmony import */ var _modules_init_smooth_scroll__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-smooth-scroll */ "./js/modules/init-smooth-scroll.js");
...
Object(_modules_init_slider__WEBPACK_IMPORTED_MODULE_3__["initSlider"])();
Object(_modules_init_dropdown__WEBPACK_IMPORTED_MODULE_4__["initDropdown"])();
Object(_modules_init_smooth_scroll__WEBPACK_IMPORTED_MODULE_5__["initSmoothScroll"])();
...
var initDropdown = function initDropdown() {
  var guaranteeTypesBtn = document.querySelectorAll('.js-guarantee-types-btn');
  var guaranteeTypesContent = document.querySelector('.js-guarantee-types-content');

  if (guaranteeTypesBtn.length) {
    guaranteeTypesBtn.forEach(function (btn) {
      btn.addEventListener('click', function () {
        guaranteeTypesContent.classList.toggle('visually-hidden');
      });
    });
  }
    ...
    try {
      var _loop = function _loop() {
        ...
        anchor.addEventListener('click', function (evt) {
          evt.preventDefault();
          var destinationId = anchor.getAttribute('href').substr(1);
