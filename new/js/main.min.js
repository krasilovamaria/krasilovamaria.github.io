...
/* harmony import */ var _modules_init_focus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-focus */ "./js/modules/init-focus.js");
/* harmony import */ var _modules_init_validate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-validate */ "./js/modules/init-validate.js");
...
Object(_modules_init_focus__WEBPACK_IMPORTED_MODULE_3__["initFocus"])();
Object(_modules_init_validate__WEBPACK_IMPORTED_MODULE_4__["initValidate"])();

/***/ }),

/***/ "./js/modules/init-focus.js":
/*!**********************************!*\
  !*** ./js/modules/init-focus.js ***!
  \**********************************/
/*! exports provided: initFocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFocus", function() { return initFocus; });
...
/*!*************************************!*\
  !*** ./js/modules/init-validate.js ***!
  \*************************************/
/*! exports provided: initValidate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initValidate", function() { return initValidate; });
/* harmony import */ var _utils_validate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/validate */ "./js/utils/validate.js");
...
var initValidate = function initValidate() {
  ...
  var inputInstagram = document.querySelector('#instagram');
  var inputEmail = document.querySelector('#email');
  var inputPasswordNew = document.querySelector('#password-new');
  var inputPassword = document.querySelector('#password');
  var regName = /[А-Яа-яЁё]/;
  var regInstagram = /^[a-zA-Z0-9_.]{1,20}$/;
  var regEmail = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
  var regPassword = /^[a-zA-Z0-9_.]{4,8}$/;
  var submitRequest = document.querySelector('.js-request');

  if (submitRequest) {
    submitRequest.addEventListener('click', function (evt) {
      evt.preventDefault();

      if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regName, inputName.value)) {
        Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(inputName, 'error-message-username', 'Ошибка! Введите имя на русском языке, к примеру, Сергей');
      } else if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regInstagram, inputInstagram.value)) {
        Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(inputInstagram, 'error-message-instagram', 'Ошибка! Введите ник Instagram, к примеру, meshkov.serge');
      } else if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regEmail, inputEmail.value)) {
        Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(inputEmail, 'error-message-email', 'Ошибка! Введите email, к примеру, max@gmail.com');
      } else {
        form.submit();
      }
    });
  ...
  var submitSignUp = document.querySelector('.js-sign-up');

  if (submitSignUp) {
    submitSignUp.addEventListener('click', function (evt) {
      evt.preventDefault();

      if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regInstagram, inputInstagram.value)) {
        Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(inputInstagram, 'error-message-instagram', 'Ошибка! Введите ник Instagram, к примеру, meshkov.serge');
      } else if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regEmail, inputEmail.value)) {
        Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(inputEmail, 'error-message-email', 'Ошибка! Введите email, к примеру, max@gmail.com');
      } else if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regPassword, inputPasswordNew.value)) {
        Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(inputPasswordNew, 'error-message-password-new', 'Ошибка! Введите цифры и латинские буквы, от 4 до 8 символов');
      } else if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regPassword, inputPassword.value)) {
        Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(inputPassword, 'error-message-password', 'Ошибка! Введите цифры и латинские буквы, от 4 до 8 символов');
      } else if (inputPasswordNew.value !== inputPassword.value) {
        Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(inputPassword, 'error-message-password', 'Ошибка! Пароль не совпадает');
      } else {
        form.submit();
      }
    });
  ...
  var submitForgotPassword = document.querySelector('.js-forgot-password');

  if (submitForgotPassword) {
    submitForgotPassword.addEventListener('click', function (evt) {
      evt.preventDefault();

      if (!Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["getValidate"])(regEmail, inputEmail.value)) {
        Object(_utils_validate__WEBPACK_IMPORTED_MODULE_0__["notValid"])(inputEmail, 'error-message-email', 'Ошибка! Введите email, к примеру, max@gmail.com');
      } else {
        form.submit();
      }
...
/*!******************************!*\
  !*** ./js/utils/validate.js ***!
  \******************************/
/*! exports provided: getValidate, notValid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getValidate", function() { return getValidate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "notValid", function() { return notValid; });
var getValidate = function getValidate(regex, value) {
  return regex.test(value);
};

var notValid = function notValid(input, element, message) {
