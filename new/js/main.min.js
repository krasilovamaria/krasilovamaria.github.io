...
/* harmony import */ var _modules_init_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-slider */ "./js/modules/init-slider.js");
/* harmony import */ var _modules_init_dropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-dropdown */ "./js/modules/init-dropdown.js");
/* harmony import */ var _modules_init_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-forms */ "./js/modules/init-forms.js");
...
Object(_modules_init_slider__WEBPACK_IMPORTED_MODULE_2__["initSlider"])();
Object(_modules_init_dropdown__WEBPACK_IMPORTED_MODULE_3__["initDropdown"])();
Object(_modules_init_forms__WEBPACK_IMPORTED_MODULE_4__["initForms"])();
...
var initDropdown = function initDropdown() {
  var guaranteeBtn = document.querySelector('.js-guarantee-btn');
  var guarantee = document.querySelector('.js-guarantee');

  if (guaranteeBtn) {
    guaranteeBtn.addEventListener('click', function (evt) {
      evt.preventDefault();
      guarantee.classList.toggle('visually-hidden');
    });
  }
  ...
  if (cards) {
    cards.forEach(function (card) {
      var btn = card.querySelector('.js-btn-dropdown');
      var elements = card.querySelectorAll('.js-change-content');
      btn.addEventListener('click', function () {
        elements.forEach(function (el) {
          var className = el.dataset.dropdown;
...
var initForms = function initForms() {
  ...
  var fields = document.querySelectorAll('.form__item');
  fields.forEach(function (field) {
    field.addEventListener('input', function (evt) {
      if (evt.target.value.length > 0 && !field.classList.contains('filled')) {
        field.classList.add('filled');
      } else if (evt.target.value.length === 0 && field.classList.contains('filled')) {
        field.classList.remove('filled');
      }
    });
  });
  forms.forEach(function (form) {
    var sumbitBtn = form.querySelector('.form__btns button');
    var formFields = form.querySelectorAll('.form__item');
...
var initSlider = function initSlider() {
  ...
  var sliderBtnNext = document.querySelector('.swiper-button-next');
  var sliderBtnPrev = document.querySelector('.swiper-button-prev');
  ...
  if (sliderContainer && sliderPagination && sliderBtnNext && sliderBtnPrev) {
    initSwiper();
  }
};
