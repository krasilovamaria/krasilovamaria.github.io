...
/* harmony import */ var _vendor_choices_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vendor/choices.min */ "./js/vendor/choices.min.js");
...
window.Choices = function (e) {
      ...
      return t = e, (i = [{
        ...
        value: function value(e, t) {
          ...
          if (null != o) {
            ...
            } else if (a(o)) for (var j = 0, k = o.length; j < k; j += 1) {
              this._analyze({
                key: i,
                arrayIndex: j,
                value: o[j],
  ...
  var n = {
    containerOuter: function containerOuter(e, t, i, n, r, o) {
      ...
      return a.dataset.type = o, t && (a.dir = t), n && (a.tabIndex = 0), i && (a.setAttribute("role", r ? "combobox" : "listbox"), r && a.setAttribute("aria-autocomplete", "list")), a.setAttribute("aria-haspopup", "true"), a.setAttribute("aria-label", "Выберите из списка"), a.setAttribute("aria-expanded", "false"), a;
    },
