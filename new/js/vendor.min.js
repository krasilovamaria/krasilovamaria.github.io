...
var container = document.querySelector('.comparison__table-wrapper');

if (container) {
  // так у нас не будет ошибки если элемента не обнаружено на странице = )
  ...
  var comparisonScroll = document.querySelector('.ps__rail-x');
  comparisonScroll.classList.add('comparison__scrollbar');
  container.scrollTop = 10;
  ps.update();
}

document.addEventListener('click', function (evt) {
  if (evt.target.closest('[data-scroll="right"]')) {
    if (container) {
      // так у нас не будет ошибки если элемента не обнаружено на странице = )
      container.scrollBy({
        left: 100,
  ...
  } else if (evt.target.closest('[data-scroll="left"]')) {
    if (container) {
      // так у нас не будет ошибки если элемента не обнаружено на странице = )
      container.scrollBy({
        left: -100,
