...
<php lang="ru">
  <head>
    <title>Регистрация - YogaApp</title>
    <meta charset="utf-8"/>
  ...
  <circle cx="52.5" cy="25.5" r="2.5" fill="white"/>
    ...
    <div class="wrapper">
      ...
      <main class="login">
        ...
        <h2>Рад нашему знакомству!</h2>
        <form class="form" method="get" action="#">
          <div class="input">
            <label class="visually-hidden" for="username"></label>
            <input name="username" id="username" type="text" placeholder="Имя" autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-username">Ошибка! Введите цифры и латинские буквы, от 4 до 20 символов</span>
          </div>
          <div class="input">
            <label class="visually-hidden" for="tel"></label>
            <input name="tel" id="tel" type="tel" placeholder="Телефон" autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-tel">Ошибка! Введите цифры</span>
          </div>
          <div class="input">
          ...
          <div class="input">
            ...
            <input name="password" id="password" type="text" placeholder="Придумайте пароль" autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-password">Ошибка! Введите цифры и латинские буквы, от 4 до 20 символов</span>
          </div>
          <div class="input">
            <label class="visually-hidden" for="code"></label>
            <input name="code" id="code" type="text" placeholder="Код пользователя, если есть" autocomplete="off" required="required" value=""/><span class="visually-hidden" id="error-message-code">Ошибка! Такого кода не существует</span>
          </div><a class="button button--border-circle" href="create-workout.php">Зарегистрироваться</a>
          <div class="form__col form__col--start"><a class="button button--no-padding" href="login.php">Я уже зарегистрирован :)</a></div>
        </form>
      </main>
    </div>
